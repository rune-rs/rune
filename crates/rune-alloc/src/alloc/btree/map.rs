...
use crate::alloc::{
    AllocError, Allocator, Box, CustomError, Error, Global, TryClone, TryFromIteratorIn,
};
...
impl<K, V, A: Allocator> BTreeMap<K, V, A> {
    ...
    ///
    /// ```
    /// use rune_alloc::{BTreeMap, Global};
    ///
...
impl<K, V, A: Allocator> BTreeMap<K, V, A> {
    ...
    ///
    /// ```
    /// use rune_alloc::{BTreeMap, CustomError};
    ///
    /// let mut map = BTreeMap::new();
    ...
    ///
    /// ```
    /// use rune_alloc::{BTreeMap, IteratorExt};
    ///
    ...
    ///
    /// ```
    /// use rune_alloc::{Vec, BTreeMap, IteratorExt};
    ///
    ...
    ///
    /// ```
    /// use rune_alloc::{BTreeMap, Vec, IteratorExt};
    ///
    /// let mut a = BTreeMap::new();
    /// a.try_insert(2, "b")?;
    /// a.try_insert(1, "a")?;
...
impl<K, V, A: Allocator> BTreeMap<K, V, A> {
    ...
    ///
    /// ```
    /// use rune_alloc::{BTreeMap, Vec, String, TryClone};
    ///
    /// let mut a = BTreeMap::new();
