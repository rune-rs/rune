...
use crate::alloc::{AllocError, Allocator, Error, Global, TryClone, TryExtend, TryFromIteratorIn};
...
impl<T, A: Allocator> BTreeSet<T, A> {
    ...
    ///
    /// ```
    /// use rune_alloc::{BTreeSet, Global};
    ///
    ...
    ///
    /// ```
    /// use rune_alloc::{BTreeSet, Vec, IteratorExt};
    ///
