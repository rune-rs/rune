...
use crate::alloc::{
    Allocator, Error, Global, SizedTypeProperties, TryClone, TryExtend, TryFromIteratorIn, Vec,
};
...
impl<T, A: Allocator> VecDeque<T, A> {
    ...
    ///
    /// ```
    /// use rune_alloc::{VecDeque, Global};
    ///
    ...
    ///
    /// ```
    /// use rune_alloc::{VecDeque, Error, TryExtend};
    ///
    ...
    ///
    /// ```
    /// use rune_alloc::{VecDeque, TryExtend};
    ///
    ...
    ///
    /// ```
    /// use rune_alloc::{Vec, VecDeque, IteratorExt};
    ///
    /// let mut buf = VecDeque::new();
    /// buf.try_push_back(5)?;
    /// buf.try_push_back(3)?;
    ...
    ///
    /// ```
    /// use rune_alloc::{VecDeque, IteratorExt};
    ///
...
impl<T, A: Allocator> From<VecDeque<T, A>> for Vec<T, A> {
    ...
    ///
    /// ```
    /// use rune_alloc::{VecDeque, Vec, IteratorExt};
    ///
    /// // This one is *O*(1).
