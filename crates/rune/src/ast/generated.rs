...
impl Kind {
    ...
    pub(crate) fn is_node(&self) -> bool {
        match self {
            ...
            Self::Item => true,
            Self::ItemEnum => true,
            Self::ItemStruct => true,
            Self::ItemConst => true,
            Self::ItemStatic => true,
            Self::ItemFn => true,
            Self::ItemImpl => true,
            Self::ItemMod => true,
            Self::ItemFileMod => true,
            Self::ItemUse => true,
            Self::ItemUsePath => true,
            Self::ItemUseGroup => true,
            Self::Variant => true,
            Self::Field => true,
            Self::EmptyBody => true,
            Self::StructBody => true,
            Self::TupleBody => true,
            Self::FnArgs => true,
            Self::Block => true,
            Self::BlockBody => true,
            ...
            Self::ExprArray => true,
            Self::ExprUnary => true,
            Self::ExprBinary => true,
            Self::ExprGroup => true,
            Self::ExprEmptyGroup => true,
            Self::ExprTry => true,
            Self::ExprIndex => true,
            Self::ExprCall => true,
            Self::ExprMacroCall => true,
            Self::ExprObject => true,
            Self::ExprMatch => true,
            Self::ExprMatchArm => true,
            Self::ExprSelect => true,
            Self::ExprSelectArm => true,
            Self::ExprAwait => true,
            Self::ExprField => true,
            Self::ExprOperator => true,
            Self::ExprIf => true,
            Self::ExprElse => true,
            Self::ExprElseIf => true,
            Self::ExprWhile => true,
            Self::ExprLoop => true,
            Self::ExprBreak => true,
            Self::ExprContinue => true,
            Self::ExprReturn => true,
            Self::ExprYield => true,
            Self::ExprFor => true,
            Self::ExprRange => true,
            Self::ExprRangeInclusive => true,
            Self::ExprRangeTo => true,
            Self::ExprRangeToInclusive => true,
            Self::ExprRangeFrom => true,
            Self::ExprRangeFull => true,
            Self::ExprAssign => true,
            Self::Lit => true,
            Self::ExprClosure => true,
            Self::Pat => true,
            Self::PatArray => true,
            Self::PatTuple => true,
            Self::PatObject => true,
            Self::PatIgnore => true,
            Self::Path => true,
            Self::PathGenerics => true,
            Self::Condition => true,
            Self::ClosureArguments => true,
            Self::AnonymousObjectKey => true,
            Self::Attribute => true,
            Self::InnerAttribute => true,
            Self::Modifiers => true,
            Self::ModifierSuper => true,
            Self::ModifierSelf => true,
            Self::ModifierCrate => true,
            Self::ModifierIn => true,
            Self::TokenStream => true,
            Self::TemplateString => true,
            _ => false,
        }
    }
