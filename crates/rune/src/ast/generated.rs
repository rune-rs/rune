...
impl parse::IntoExpectation for Kind {
    fn into_expectation(self) -> parse::Expectation {
        match self {
            ...
            Self::Local => parse::Expectation::Syntax("`let <pat> = <expr>;`"),
            ...
            Self::ItemConst => {
                parse::Expectation::Syntax("a constant item, like `const <ident> = <expr>;")
            }
            ...
            Self::EnumName => parse::Expectation::Syntax("the name of an enum"),
            Self::EnumVariants => parse::Expectation::Syntax("the variants part of an enum"),
            Self::Variant => parse::Expectation::Syntax("a variant"),
            Self::VariantName => parse::Expectation::Syntax("the name of a variant"),
            Self::StructName => parse::Expectation::Syntax("the name of a struct"),
            ...
            Self::AnonymousObjectKey => parse::Expectation::Syntax("the `#{` anonymous object key"),
