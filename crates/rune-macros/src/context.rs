...
impl Context {
    ...
    pub(crate) fn tokens_with_module(&self, module: Option<&syn::Path>) -> Tokens {
        ...
        Tokens {
            ...
            const_construct_impl: path(m, ["__priv", "ConstConstructImpl"]),
            const_value: path(m, ["__priv", "ConstValue"]),
            const_value_buf: path(m, ["__priv", "ConstValueBuf"]),
...
pub(crate) struct Tokens {
    ...
    pub(crate) const_construct_impl: syn::Path,
    pub(crate) const_value: syn::Path,
    pub(crate) const_value_buf: syn::Path,
